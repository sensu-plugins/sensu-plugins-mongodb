  ...
  describe 'mongodb 2.6.11' do
    ...
    it 'get metrics' do
      ...
      expect(result).to eq(
        ...
        'databaseSizes.admin.indexSize' => 245_28,
  ...
  describe 'mongodb 3.2.9' do
    ...
    it 'get metrics' do
      ...
      expect(result).to eq(
        ...
        'databaseSizes.admin.avgObjSize' => 106.18181818181819,
        'databaseSizes.admin.collections' => 4,
        'databaseSizes.admin.dataSize' => 116_8,
        'databaseSizes.admin.fileSize' => 671_088_64,
        ...
        'databaseSizes.admin.storageSize' => 286_72,
        'mem.pageFaults' => 0,
        'mem.heap_size_bytes' => 645_201_92,
        'lock.totalTime' => 111_200_200_0,
        'lock.queue_total' => 0,
        'lock.queue_readers' => 0,
        'lock.queue_writers' => 0,
        ...
        'network.bytesIn' => 793_2,
        'network.bytesOut' => 182_742,
        ...
        'mem.current_allocated_bytes' => 601_839_28,
        ...
        'wiredTiger.data_handle.connection_sweep_time_of_death_sets' => 72,
        'wiredTiger.reconciliation.fast_path_pages_deleted' => 0,
        ...
        'wiredTiger.cache.eviction_server_populating_queue_but_not_evicting_pages' => 0,
        'wiredTiger.cache.eviction_server_skipped_very_large_page' => 0,
        ...
        'wiredTiger.cache.failed_eviction_of_pages_that_exceeded_the_in_memory_maximum' => 0,
        'wiredTiger.cache.pages_evicted_because_they_exceeded_the_in_memory_maximum' => 0,
        'wiredTiger.cache.tracked_bytes_belonging_to_leaf_pages_in_the_cache' => 312_12,
        'wiredTiger.cache.tracked_bytes_belonging_to_overflow_pages_in_the_cache' => 0,
        'wiredTiger.cache.eviction_server_candidate_queue_empty_when_topping_up' => 0,
        'wiredTiger.cache.bytes_written_from_cache' => 191_44,
        'wiredTiger.cache.eviction_server_slept_because_we_did_not_make_progress_with_eviction' => 0,
        'wiredTiger.cache.pages_queued_for_urgent_eviction' => 0,
        'wiredTiger.cache.eviction_currently_operating_in_aggressive_mode' => 0,
        'wiredTiger.cache.tracked_bytes_belonging_to_internal_pages_in_the_cache' => 136_31,
        'wiredTiger.cache.bytes_currently_in_the_cache' => 448_43,
        ...
        'wiredTiger.cache.in_memory_page_passed_criteria_to_be_split' => 0,
        ...
        'wiredTiger.cache.bytes_read_into_cache' => 754_1,
        ...
        'wiredTiger.cache.pages_written_requiring_in_memory_restoration' => 0,
        ...
        'wiredTiger.cache.in_memory_page_splits' => 0,
        'wiredTiger.cache.internal_pages_evicted' => 0,
        'wiredTiger.cache.maximum_bytes_configured' => 107_374_182_4.0,
        ...
        'wiredTiger.log.log_sync_dir_time_duration_usecs' => 16,
        ...
        'wiredTiger.log.maximum_log_file_size' => 104_857_600,
        'wiredTiger.log.records_processed_by_log_scan' => 10,
        'wiredTiger.log.total_log_buffer_size' => 335_544_32,
        'wiredTiger.log.log_records_too_small_to_compress' => 6,
        'wiredTiger.log.log_force_write_operations_skipped' => 121_66,
        'wiredTiger.log.log_scan_operations' => 3,
        'wiredTiger.log.pre_allocated_log_files_used' => 0,
        'wiredTiger.log.pre_allocated_log_files_not_ready_and_missed' => 1,
        'wiredTiger.log.total_size_of_compressed_records' => 318_3,
        'wiredTiger.log.pre_allocated_log_files_prepared' => 2,
        'wiredTiger.log.log_sync_time_duration_usecs' => 142_38,
        'wiredTiger.log.total_in_memory_size_of_compressed_records' => 474_9,
        'wiredTiger.log.yields_waiting_for_previous_log_file_close' => 0,
        'wiredTiger.log.log_records_not_compressed' => 1,
        'wiredTiger.log.log_force_write_operations' => 121_68,
        ...
        'wiredTiger.log.number_of_pre_allocated_log_files_to_create' => 2,
        'wiredTiger.log.log_bytes_written' => 473_6,
        'wiredTiger.log.busy_returns_attempting_to_switch_slots' => 0,
        'wiredTiger.log.consolidated_slot_joins' => 11,
        'wiredTiger.log.log_files_manually_zero_filled' => 0,
        'wiredTiger.log.log_bytes_of_payload_data' => 349_7,
        'wiredTiger.log.log_flush_operations' => 110_23,
        'wiredTiger.log.log_sync_operations' => 7,
        'wiredTiger.log.log_scan_records_requiring_two_reads' => 4,
        'wiredTiger.log.logging_bytes_consolidated' => 435_2,
        'wiredTiger.log.log_server_thread_write_LSN_walk_skipped' => 207_8,
        ...
        'wiredTiger.transaction.transaction_fsync_calls_for_checkpoint_before_allocating_the_transaction_ID' => 19,
        'wiredTiger.transaction.transaction_fsync_duration_for_checkpoint_after_allocating_the_transaction_ID_usecs' => 210_03,
        'wiredTiger.transaction.transaction_fsync_duration_for_checkpoint_before_allocating_the_transaction_ID_usecs' => 647_72,
        'wiredTiger.transaction.transaction_checkpoint_most_recent_time_msecs' => 6,
        ...
        'wiredTiger.transaction.transaction_checkpoint_max_time_msecs' => 8,
        'wiredTiger.transaction.number_of_named_snapshots_created' => 0,
        'wiredTiger.transaction.transaction_checkpoint_min_time_msecs' => 6,
        'wiredTiger.transaction.transaction_checkpoint_total_time_msecs' => 28,
        ...
        'wiredTiger.connection.memory_re_allocations' => 457_7,
        'wiredTiger.connection.pthread_mutex_shared_lock_write_lock_calls' => 129_6,
        'wiredTiger.connection.auto_adjusting_condition_resets' => 9,
        'wiredTiger.connection.pthread_mutex_condition_wait_calls' => 145_31,
        'wiredTiger.connection.memory_frees' => 191_13,
        'wiredTiger.connection.pthread_mutex_shared_lock_read_lock_calls' => 257_4,
        'wiredTiger.connection.total_fsync_I/Os' => 190,
        'wiredTiger.connection.files_currently_open' => 9,
        'wiredTiger.connection.memory_allocations' => 197_00,
        'wiredTiger.connection.auto_adjusting_condition_wait_calls' => 337_2,
        'wiredTiger.connection.total_write_I/Os' => 38,
        'wiredTiger.session.open_cursor_count' => 20,
        'wiredTiger.session.open_session_count' => 16,
        'wiredTiger.block_manager.bytes_read' => 696_32,
        'wiredTiger.block_manager.blocks_read' => 16,
        'wiredTiger.block_manager.blocks_pre_loaded' => 5,
        'wiredTiger.block_manager.bytes_written' => 110_592,
        ...
        'wiredTiger.thread_yield.page_acquire_time_sleeping_usecs' => 0,
