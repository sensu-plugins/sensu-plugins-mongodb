  ...
  describe 'mongodb 3.2.9' do
    ...
    it 'get metrics' do
      ...
      expect(result).to eq(
        ...
        'metrics.wired_tiger.cache.bytes_currently_in_the_cache' => 15825,
        'metrics.wired_tiger.cache.bytes_read_into_cache' => 0,
        'metrics.wired_tiger.cache.bytes_written_from_cache' => 12762,
        'metrics.wired_tiger.cache.maximum_bytes_configured' => 8589934592,
        ...
        'metrics.wired_tiger.log.log_flush_operations' => 42581,
